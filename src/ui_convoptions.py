...
class Ui_Dialog(object):
    def setupUi(self, Dialog: QDialog):
        ...
        self.lbl_rename.setText("Rename filename (regex)")
        ...
        self.lbl_rename_to = QLabel(self.scrollAreaContents)
        self.lbl_rename_to.setText("to")
        self.hLayout_rename.addWidget(self.lbl_rename_to)
        self.lineEdit_rename_to = QLineEdit(self.scrollAreaContents)
        self.lineEdit_rename_to.setObjectName('lineEdit_rename_to')
        self.hLayout_rename.addWidget(self.lineEdit_rename_to)
        self.hLayout_rename.setStretch(0, 1)
        self.hLayout_rename.setStretch(2, 3)
        self.hLayout_rename.setStretch(4, 3)
